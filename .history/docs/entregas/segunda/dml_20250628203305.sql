...
Versao: 1.1
Data: 28/06/2025
Descricao: Ajustando DML para a nova estrutura de localizacao (tabela 'locais' unificando 'salas' e 'corredores').
            Uso de 'tipo_local' para distinguir entre salas e corredores.
            Implementacao da tabela 'conexoes_locais' para gerenciar as ligacoes.
...
INSERT INTO public.tipos_monstro (tipo) VALUES ('agressivo'), ('pacifico');
...
WITH 
        ...
        andar_criado AS (
                ...
                SELECT 'Primeiro andar do templo de Cthulhu', 
                       ...
                       (SELECT id FROM locais_criados WHERE descricao LIKE 'O ar pesa%' AND tipo_local = 'Sala') -- Pegando o ID do local que eh uma sala
                RETURNING id
        )
-- A uniao agora eh feita na nova tabela conexoes_locais
INSERT INTO public.conexoes_locais (id_local_origem, id_local_destino)
VALUES
    -- Conexoes entre Salas e Corredores (e vice-versa, se bidirecional)
    ...
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Esta camara eh uma abobada%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'O corredor estreito serpenteia adiante%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'O corredor estreito serpenteia adiante%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Esta camara eh uma abobada%' AND tipo_local = 'Sala')),

    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Esta camara eh uma abobada%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor eh estreito e serpenteia por uma serie de arcos baixos%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor eh estreito e serpenteia por uma serie de arcos baixos%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Esta camara eh uma abobada%' AND tipo_local = 'Sala')),

    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Um salao circular%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor eh estreito e serpenteia por uma serie de arcos baixos%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor eh estreito e serpenteia por uma serie de arcos baixos%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Um salao circular%' AND tipo_local = 'Sala')),
    ...
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Esta sala eh um labirinto%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Um corredor largo%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Um corredor largo%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Esta sala eh um labirinto%' AND tipo_local = 'Sala')),

    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Esta sala eh um labirinto%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor tem as paredes cobertas por uma substancia pegajosa%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor tem as paredes cobertas por uma substancia pegajosa%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Esta sala eh um labirinto%' AND tipo_local = 'Sala')),

    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Uma camara triangular%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor tem as paredes cobertas por uma substancia pegajosa%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Este corredor tem as paredes cobertas por uma substancia pegajosa%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Uma camara triangular%' AND tipo_local = 'Sala')),
    ...
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Esta eh uma sala de observacao%' AND tipo_local = 'Sala'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Um corredor que se estende em linha reta%' AND tipo_local = 'Corredor')),
    ((SELECT id FROM locais_criados WHERE descricao LIKE 'Um corredor que se estende em linha reta%' AND tipo_local = 'Corredor'), 
     (SELECT id FROM locais_criados WHERE descricao LIKE 'Esta eh uma sala de observacao%' AND tipo_local = 'Sala'));
...
WITH
  ...
  sarah AS (
    ...
    'feminino', 8, 10, 11, 14, 16, 15, 14, 13, 8, 55, 11, 11, 12, (SELECT id FROM public.locais WHERE descricao LIKE 'Esta camara eh uma abobada%' AND tipo_local = 'Sala'), (SELECT id FROM inv_sarah))
    RETURNING id
  )
...
WITH
  sabio AS (
    ...
    VALUES ('Velho Sabio', 'Guardiao do Templo', 70, 'masculino', 'Templo das Sombras', 'Arkham', (SELECT id FROM public.locais WHERE descricao LIKE 'O ar pesa%' AND tipo_local = 'Sala')) RETURNING id
  ),
  guarda AS (
    INSERT INTO public.npcs (nome, ocupacao, idade, sexo, residencia, local_nascimento, id_local)
    VALUES ('Guarda do Templo', 'Protetor das Reliquias', 45, 'masculino', 'Templo das Sombras', 'Arkham', (SELECT id FROM public.locais WHERE descricao LIKE 'Esta camara eh uma abobada%' AND tipo_local = 'Sala')) RETURNING id
  ),
  sacerdotisa AS (
    INSERT INTO public.npcs (nome, ocupacao, idade, sexo, residencia, local_nascimento, id_local)
    VALUES ('Sacerdotisa Sombria', 'Mestre dos Rituais', 50, 'feminino', 'Templo das Sombras', 'Arkham', (SELECT id FROM public.locais WHERE descricao LIKE 'Um salao circular%' AND tipo_local = 'Sala')) RETURNING id
  ),
...
WITH
  ...
  instancia_adaga AS (
    ...
    SELECT 100, id, (SELECT id FROM public.locais WHERE descricao LIKE 'Um salao circular%' AND tipo_local = 'Sala') FROM item_adaga RETURNING id
  ),
  instancia_monstro AS (
    ...
    SELECT (SELECT id FROM monstro_agressivo), (SELECT id FROM public.locais WHERE descricao LIKE 'Um salao circular%' AND tipo_local = 'Sala'), id FROM instancia_adaga RETURNING id
  )
