...
-- TABELA INVENTÁRIOS
DROP SCHEMA public CASCADE; -- Remove o schema public e todos os objetos (tabelas, views, funções, etc.) dentro dele
CREATE SCHEMA public;     -- Recria o schema public vazio
