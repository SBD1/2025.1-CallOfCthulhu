...
-- Inserindo os locais na tabela 'local' e capturando seus IDs temporariamente
...
RETURNING descricao, tipo_local, id INTO temp_locais_ids; -- Inserindo no temp table
