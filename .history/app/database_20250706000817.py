...
class DataBase:
    ...
    def character_attacks_monster(self, id_jogador: int, id_instancia_monstro: int):
        """
        Chama a stored procedure para o jogador atacar um monstro.
        Retorna um dicionário com o resultado do combate (dano_causado, vida_restante, etc.).
        """
        query = "SELECT * FROM public.sp_personagem_ataca_monstro(%s, %s);"
        params = (id_jogador, id_instancia_monstro)
