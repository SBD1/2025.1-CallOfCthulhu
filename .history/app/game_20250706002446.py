...
class Game:
    ...
    def gameplay_open_world(self):
        ...
        while True:
            ...
            print("\nO que voce deseja fazer? (Ficha [f], Inventário [i], Vasculhar [v], Monstros [p], Atacar <numero>, Sair [s])")
            ...
            if escolha == 's':
                ...
                input("\nPressione Enter para continuar...")
                continue
            elif escolha.startswith('atacar'):
                monstros_no_local = self.db.get_monsters_in_location(self.player.id_local)
                ...
                try:
                    monster_num = int(escolha.split()[1]) - 1
                    if 0 <= monster_num < len(monstros_no_local):
                        monster_to_attack = monstros_no_local[monster_num]
                    ...
                    print("Comando 'atacar' inválido. Use 'atacar <numero>'.")
                    input("Pressione Enter para continuar...")
                continue
    ...
    def gameplay_story_mode(self):
        ...
        while True:
            ...
            print("\nO que voce deseja fazer? ('ficha', 'atacar <numero>', 'sair')")
            escolha = input("> ").strip().lower()
