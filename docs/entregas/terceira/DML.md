...
Para acessar o script completo, clique no link a seguir: [Visualizar DML no GitHub](https://github.com/SBD1/2025.1-CallOfCthulhu/blob/main/src/sql-terceira/dml.sql).
...
| `2.0`  | Finaliza documento DML | [Christopher](https://github.com/wChrstphr) |     08/07/25     | [Igor Daniel](https://github.com/igorvdaniel.png) |    08/07/25     |